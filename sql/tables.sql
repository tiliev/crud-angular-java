...
CREATE TABLE `vehicle` (
  ...
  KEY `fk_vehicle_1_idx` (`idvehicletype`),
  CONSTRAINT `fk_vehicle_1` FOREIGN KEY (`idvehicletype`) REFERENCES `vehicletype` (`idvehicletype`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `vehicletype` VALUES (1,'Bike'),(2,'Motorbike'),(3,'Car');
...
-- Dump completed on 2018-09-30 19:17:44
